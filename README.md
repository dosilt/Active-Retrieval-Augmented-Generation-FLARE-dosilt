...
- 이미지 생성 프롬프트: [FLAREinstruct](docs/FLAREINSTRUCT_IMAGE_PROMPT.md) · [FLAREdirect Masking](docs/FLAREDIRECT_MASKING_IMAGE_PROMPT.md) · [FLAREdirect Question Generation](docs/FLAREDIRECT_QUESTION_IMAGE_PROMPT.md)
